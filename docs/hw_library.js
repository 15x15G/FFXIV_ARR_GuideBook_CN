// hw_library.js v1.4 - Copyright 漏 2019, Rob Chandler, The Helpware Group
...
function storage_SetItem(key, val, fLocalStorage)
{ //defaul is session storage
...
function storage_GetItem(key, defaultVal, fLocalStorage)
{ //defaul is session storage
    if (myLocalStorage && mySessionStorage)
    {
        var ret;
...
function RightFrameFound()
{ //Check no security blocks or missing right frame
    try
    {
...
function GetRightPage()
{
    ...
    else if (mySessionStorage)
    { // HTML5 sessionStorage available?
