// Copyright 漏 2009-2016, Rob Chandler.
...
/* Original Copyright 漏 2002 Jean-Claude Manoli [jc@manoli.net]
 *
...
function treeFilter(filter, sr)
{ // if search results used then 'sr' contains a list of SearchResults
